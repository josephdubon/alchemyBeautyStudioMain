    ...
    var o = {
        ...
        defaults: function (e, i) {
            ...
            return this.each(function () {
                ...
                var a = psSettings.ctbTriggerBox, r = psSettings.ctbTrigger;
        ...
        defaults: function (e, i) {
            ...
            return this.each(function () {
                ...
                var e = settings.ctbTriggerBox, i = settings.ctbTrigger;
        ...
        trigger: function (o, e, i, n, a) {
            ...
            "" != i ? (s.ksAddreloadboxIn(o, n), t.ajax({
                type: "GET", url: i, data: {}, beforeSend: function () {
                    s.ksCreateLoadBox()
            ...
            var i = t(o.reloadbox), n = i.attr("class"), s = i.prop("tagName");
            ...
            t(document).find(o.bouncingBoxes).animate({opacity: 0}, 50, function () {
                s.ksPositionAndPrepare(o, e, i, n)
            })
        }, ksPositionAndPrepare: function (o, e, i, n, a) {
            var r = t(o.reloadbox), c = r.attr("id"), l = r.position(), d = r.width(), b = r.css("margin-left"),
                u = r.css("margin-left"), f = l.left + parseFloat(b);
            if (reloadboxRightAbsolute = l.left + parseFloat(b) + d - parseFloat(u), $reloadboxIn = t("#" + n), loadSelector = e.attr("data-ks-load-selector"), a) var h = i.match(/<\/*html\s+.*id="([^"].*)".*>/),
                g = i.match(/<\/*body\s+.*id="([^"].*)".*>/), p = i.match(/<\/*html\s+.*class="([^"].*)".*>/),
                k = i.match(/<\/*body\s+.*class="([^"].*)".*>/), m = i.match(/<\/*title>(.*)<\/title>/);
            if (r.addClass("ks-ctb-box-out").css({
                ...
                if (o.loadBox) var x = t(i).filter(o.loadBox); else if (loadSelector) x = t(i).filter(loadSelector); else x = t(i).filter("#" + c);
                reloadboxInContents = x.html();
                var y = x.attr("class")
            } else {
                if (o.loadBox) x = t(i).find(o.loadBox); else if (loadSelector) x = t(i).find(loadSelector); else x = t(i).find("#" + c);
                reloadboxInContents = x.html();
                y = x.attr("class")
            }
            ...
            var w = $reloadboxIn.find("img"), v = 0;
            ...
            var h = t(o.reloadbox), g = h.attr("id"), p = t("#" + e), k = p.outerHeight(),
                m = (p.outerWidth(), h.outerHeight()), x = t(window).outerHeight(), y = t(window).outerWidth(),
                w = i.prop("hash");
            if (clearTimeout(loadTimer), s.ksRemoveLoadBox(), o.direction) {
                ...
                switch (o.direction) {
                    case"left-to-right":
                    case"right-to-left":
                        var S = o.inDuration, B = o.outDuration;
            ...
            o.bouncingBoxes ? t(document).find(o.bouncingBoxes).animate({opacity: 1}, 1400, function () {
                s.ksctbCallback()
            }) : s.ksctbCallback()
