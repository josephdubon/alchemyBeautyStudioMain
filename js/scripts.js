//   all ------------------
function initalchemyBeautyStudio() {
  'use strict';
  ...
  if ($('.background-youtube-wrapper').length) {
    ...
    $(
      'head script[src="https://s.ytimg.com/yts/jsbin/www-widgetapi-vfll-F3yY/www-widgetapi.js"]'
    ).remove();
  }
...
$(
  "<div class='page-load'><div class='page-load_bg'><span></span></div><div class='page-load_bg2'></div></div>"
).appendTo('#main');
//   Init Ajax------------------
$(function () {
  $.coretemp({
